    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
        <ul class="navbar-nav">
            ...
            <li class="nav-item active btn-primary">
                <a class="nav-link" href="login">Login<span class="sr-only">(Página atual)</span></a>
            </li>
...
<div class="container">
    ...
    <form>
        ...
        <a href="cadastroUsuario"><small id="emailHelp" class="form-text text-muted">Ainda sem cadastro? Cadastre-se.</small>
        </a>
    </form>
</div>
